<div class="account">
	...
	<div class="card card-body border-0 rounded-0 flex-column mb-4">
		<div class="account-stats">
			<div class="row row-cols-2 row-cols-xl-3 row-cols-xxl-4 g-2">
				{{{ if !reputation:disabled }}}
				<div class="stat">
					<div class="align-items-center justify-content-center card card-header px-0 py-3 border-0 rounded-0 h-100">
				...
				<div class="stat">
					<div class="align-items-center justify-content-center card card-header px-0 py-3 border-0 rounded-0 h-100 gap-2">
