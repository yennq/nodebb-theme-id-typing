<li component="post" class="posts-list-item card border-0 rounded-3 mb-3 {{{if ../deleted }}}deleted{{{ else }}}{{{ if ../topic.deleted }}} deleted{{{ end }}}{{{ end }}}{{{ if ../topic.scheduled }}} scheduled{{{ end }}}" data-pid="{../pid}" data-uid="{../uid}">
    <div class="card-body">
